        ...
        >
          <div className={`transition-all duration-700 delay-100 ${
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.linkedin.com/groups/16098122/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 hover:scale-110 transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
